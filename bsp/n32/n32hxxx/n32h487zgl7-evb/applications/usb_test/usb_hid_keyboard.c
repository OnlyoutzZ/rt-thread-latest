 ...
 *
 * N32H487ZGL7-EVB USBFSDEV HID keyboard test:
 *  - WKUP(PA0)/KEY1(PC13)/KEY2(PA15)/KEY3(PC8) -> type A/B/C/D to the host
 *  - host CapsLock -> LED2(PB4), host NumLock -> LED3(PA8)
 */
...
/* Host CapsLock -> LED2(PB4), host NumLock -> LED3(PA8) */
#define LED2_CAPS_PIN GET_PIN(B, 4)
...
static const char *string_descriptors[] = {
    ...
    "N32",                        /* Manufacturer */
    "N32H487 EVB HID Keyboard",   /* Product */
