 ...
 * Change Logs:
 * Date           Author           Notes
 * 2026-08-19     ox-horse         hwtimer test for N32H47x_48x
 */

#include <rtthread.h>
#include <rtdevice.h>

#if defined(BSP_USING_CLOCK_TIMER) && defined(BSP_USING_GTIM8)

#define HWTIMER_DEV_NAME "timer12" /* GTIM8 */
...
MSH_CMD_EXPORT(hwtimer_sample, test N32H47x_48x GTIM8 hwtimer);
