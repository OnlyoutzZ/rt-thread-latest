 ...
 * Change Logs:
 * Date           Author           Notes
 * 2026-08-19     ox-horse         LPTIM test for N32H49x
 */
...
MSH_CMD_EXPORT(lptim_sample, test N32H49x LPTIM2 oneshot);
...
MSH_CMD_EXPORT(lptim_period_sample, test N32H49x LPTIM2 software period);
...
MSH_CMD_EXPORT(lptim_info_sample, test N32H49x LPTIM2 information);
...
MSH_CMD_EXPORT(lptim_stop_sample, stop N32H49x LPTIM2 test);
